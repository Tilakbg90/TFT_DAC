...
#ifndef IR_LOGO_SMALL_H_FILE
#define IR_LOGO_SMALL_H_FILE
/*****************************************************************************
 * SECTION:  Includes
 *****************************************************************************/
 ...
 * Bitmap Structure
 * Label: null
 * Description:  63x60 pixels, 16-bits per pixel
 ***********************************/
extern const IMAGE_EXTERNAL null;
#define null_WIDTH     (63)
#define null_HEIGHT    (60)
#define null_SIZE      (7566)
#endif
