...
#ifndef LOGO_SMALL_H_FILE
#define LOGO_SMALL_H_FILE
/*****************************************************************************
 * SECTION:  Includes
 *****************************************************************************/
 ...
 * Bitmap Structure
 * Label: null
 * Description:  103x71 pixels, 16-bits per pixel
 ***********************************/
extern const IMAGE_EXTERNAL null;
#define null_WIDTH     (103)
#define null_HEIGHT    (71)
#define null_SIZE      (14632)
#endif
