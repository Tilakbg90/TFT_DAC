...
#ifndef IR_LOGO_SMALL3_H_FILE
#define IR_LOGO_SMALL3_H_FILE
/*****************************************************************************
 * SECTION:  Includes
 *****************************************************************************/
 ...
 * Bitmap Structure
 * Label: null
 * Description:  57x57 pixels, 16-bits per pixel
 ***********************************/
extern const IMAGE_EXTERNAL null;
#define null_WIDTH     (57)
#define null_HEIGHT    (57)
#define null_SIZE      (6504)
#endif
