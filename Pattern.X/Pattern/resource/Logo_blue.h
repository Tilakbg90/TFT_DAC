...
#ifndef LOGO_BLUE_H_FILE
#define LOGO_BLUE_H_FILE
/*****************************************************************************
 * SECTION:  Includes
 *****************************************************************************/
 ...
 * Bitmap Structure
 * Label: null
 * Description:  103x94 pixels, 4-bits per pixel
 ***********************************/
extern const IMAGE_EXTERNAL null;
#define null_WIDTH     (103)
#define null_HEIGHT    (94)
#define null_SIZE      (4926)
#endif
